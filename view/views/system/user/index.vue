<template>
    <div class="app-container">
        <!--查询  -->
        <el-row>
            <el-input style="width:200px;" v-model="listQuery.content" placeholder="手机号码\用户名"></el-input>
        ...
        <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column width="100px" align="center" label="单点登陆">
                <template slot-scope="scope">
                    <el-tag :type="scope.row.web_sso | statusFilter">{{scope.row.web_sso == 1?"是":"否"}}</el-tag>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="40%">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="120px">
              ...
              <el-form-item label="上传头像" prop="admin_avatar">
                ...
                <el-upload class="avatar-uploader" action="http://upload.qiniu.com" :data="form"  :multiple="true"
...
<script>
    import {getSystemList,getSystemRole,updateSystemRole,updateSystemStatus,createNewAdministrator} from '@/api/system'
