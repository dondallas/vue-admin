...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_set__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tree__ = __webpack_require__(435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_system__ = __webpack_require__(415);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash_debounce__ = __webpack_require__(430);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        initData: function initData() {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_system__["a" /* listAllPermissions */])().then(function (res) {
                //按parent分组的按钮权限
        ...
        handleAddButton: function handleAddButton(data) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["a" /* resetTemp */])(this.temp);
        ...
        addButton: function addButton() {
            ...
            this.$refs['dataForm'].validate(function (valid) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_system__["b" /* createNewPerm */])(data).then(function (res) {
                    if (res) {
        ...
        updateButton: function updateButton() {
            ...
            this.$refs['dataForm'].validate(function (valid) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_system__["c" /* updatePerm */])(data).then(function (res) {
                    if (res) {
        ...
        handleDeleleButton: function handleDeleleButton(data) {
            ...
            this.$confirm('您确定要永久删除该权限？', '提示', __WEBPACK_IMPORTED_MODULE_5__utils_constants__["b" /* confirm */]).then(function () {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_system__["d" /* deletePerm */])({ pval: data.pval }).then(function (res) {
                    if (res) {
                        _this6.initData();
        ...
        handleSyncMenuPermissionData: function handleSyncMenuPermissionData() {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_system__["e" /* syncMenuPerms */])({ data: list }).then(function (res) {
                _this7.initData();
...
var update = __webpack_require__(393)("4f163ab2", content, false);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "tips-text"
  }, [_vm._v("提示：按钮权限是依附在菜单权限下的，这样能帮助您更好区分相似的按钮权限。\n          按钮权限值建议使用前缀 "), _c('el-tag', {
    attrs: {
      "size": "mini",
      "type": "warning"
    }
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(3).rerender("data-v-64ac8d22", module.exports)
  }
}
