...
Component.options.__file = "/Users/wangxiaohui/Documents/cj/code/pos-admin/view/views/errorPage/404.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-467f3bfc", Component.options)
  } else {
    hotAPI.reload("data-v-467f3bfc", Component.options)
  }
})()}
...
// module
exports.push([module.i, ".wscn-http404-container[data-v-467f3bfc]{transform:translate(-50%,-50%);position:absolute;top:40%;left:50%}.wscn-http404[data-v-467f3bfc]{position:relative;width:1200px;padding:0 50px;overflow:hidden}.wscn-http404 .pic-404[data-v-467f3bfc]{position:relative;float:left;width:600px;overflow:hidden}.wscn-http404 .pic-404__parent[data-v-467f3bfc]{width:100%}.wscn-http404 .pic-404__child[data-v-467f3bfc]{position:absolute}.wscn-http404 .pic-404__child.left[data-v-467f3bfc]{width:80px;top:17px;left:220px;opacity:0;animation-name:cloudLeft;animation-duration:2s;animation-timing-function:linear;animation-fill-mode:forwards;animation-delay:1s}.wscn-http404 .pic-404__child.mid[data-v-467f3bfc]{width:46px;top:10px;left:420px;opacity:0;animation-name:cloudMid;animation-duration:2s;animation-timing-function:linear;animation-fill-mode:forwards;animation-delay:1.2s}.wscn-http404 .pic-404__child.right[data-v-467f3bfc]{width:62px;top:100px;left:500px;opacity:0;animation-name:cloudRight;animation-duration:2s;animation-timing-function:linear;animation-fill-mode:forwards;animation-delay:1s}@keyframes cloudLeft{0%{top:17px;left:220px;opacity:0}20%{top:33px;left:188px;opacity:1}80%{top:81px;left:92px;opacity:1}to{top:97px;left:60px;opacity:0}}@keyframes cloudMid{0%{top:10px;left:420px;opacity:0}20%{top:40px;left:360px;opacity:1}70%{top:130px;left:180px;opacity:1}to{top:160px;left:120px;opacity:0}}@keyframes cloudRight{0%{top:100px;left:500px;opacity:0}20%{top:120px;left:460px;opacity:1}80%{top:180px;left:340px;opacity:1}to{top:200px;left:300px;opacity:0}}.wscn-http404 .bullshit[data-v-467f3bfc]{position:relative;float:left;width:300px;padding:30px 0;overflow:hidden}.wscn-http404 .bullshit__oops[data-v-467f3bfc]{font-size:32px;font-weight:700;line-height:40px;color:#1482f0;opacity:0;margin-bottom:20px;animation-name:slideUp;animation-duration:.5s;animation-fill-mode:forwards}.wscn-http404 .bullshit__headline[data-v-467f3bfc]{font-size:20px;line-height:24px;color:#222;font-weight:700;opacity:0;margin-bottom:10px;animation-name:slideUp;animation-duration:.5s;animation-delay:.1s;animation-fill-mode:forwards}.wscn-http404 .bullshit__info[data-v-467f3bfc]{font-size:13px;line-height:21px;color:grey;opacity:0;margin-bottom:30px;animation-name:slideUp;animation-duration:.5s;animation-delay:.2s;animation-fill-mode:forwards}.wscn-http404 .bullshit__return-home[data-v-467f3bfc]{display:block;float:left;width:110px;height:36px;background:#1482f0;border-radius:100px;text-align:center;color:#fff;opacity:0;font-size:14px;line-height:36px;cursor:pointer;animation-name:slideUp;animation-duration:.5s;animation-delay:.3s;animation-fill-mode:forwards}@keyframes slideUp{0%{transform:translateY(60px);opacity:0}to{transform:translateY(0);opacity:1}}", "", {"version":3,"sources":["/Users/wangxiaohui/Documents/cj/code/pos-admin/view/views/errorPage/404.vue"],"names":[],"mappings":"AACA,yCACE,+BAAiC,AACjC,kBAAmB,AACnB,QAAS,AACT,QAAU,CACX,AACD,+BACE,kBAAmB,AACnB,aAAc,AACd,eAAgB,AAChB,eAAiB,CAClB,AACD,wCACI,kBAAmB,AACnB,WAAY,AACZ,YAAa,AACb,eAAiB,CACpB,AACD,gDACM,UAAY,CACjB,AACD,+CACM,iBAAmB,CACxB,AACD,oDACQ,WAAY,AACZ,SAAU,AACV,WAAY,AACZ,UAAW,AACX,yBAA0B,AAC1B,sBAAuB,AACvB,iCAAkC,AAClC,6BAA8B,AAC9B,kBAAoB,CAC3B,AACD,mDACQ,WAAY,AACZ,SAAU,AACV,WAAY,AACZ,UAAW,AACX,wBAAyB,AACzB,sBAAuB,AACvB,iCAAkC,AAClC,6BAA8B,AAC9B,oBAAsB,CAC7B,AACD,qDACQ,WAAY,AACZ,UAAW,AACX,WAAY,AACZ,UAAW,AACX,0BAA2B,AAC3B,sBAAuB,AACvB,iCAAkC,AAClC,6BAA8B,AAC9B,kBAAoB,CAC3B,AACD,qBACA,GACI,SAAU,AACV,WAAY,AACZ,SAAW,CACd,AACD,IACI,SAAU,AACV,WAAY,AACZ,SAAW,CACd,AACD,IACI,SAAU,AACV,UAAW,AACX,SAAW,CACd,AACD,GACI,SAAU,AACV,UAAW,AACX,SAAW,CACd,CACA,AACD,oBACA,GACI,SAAU,AACV,WAAY,AACZ,SAAW,CACd,AACD,IACI,SAAU,AACV,WAAY,AACZ,SAAW,CACd,AACD,IACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,AACD,GACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,CACA,AACD,sBACA,GACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,AACD,IACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,AACD,IACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,AACD,GACI,UAAW,AACX,WAAY,AACZ,SAAW,CACd,CACA,AACD,yCACI,kBAAmB,AACnB,WAAY,AACZ,YAAa,AACb,eAAgB,AAChB,eAAiB,CACpB,AACD,+CACM,eAAgB,AAChB,gBAAkB,AAClB,iBAAkB,AAClB,cAAe,AACf,UAAW,AACX,mBAAoB,AACpB,uBAAwB,AACxB,uBAAyB,AACzB,4BAA8B,CACnC,AACD,mDACM,eAAgB,AAChB,iBAAkB,AAClB,WAAY,AACZ,gBAAkB,AAClB,UAAW,AACX,mBAAoB,AACpB,uBAAwB,AACxB,uBAAyB,AACzB,oBAAsB,AACtB,4BAA8B,CACnC,AACD,+CACM,eAAgB,AAChB,iBAAkB,AAClB,WAAY,AACZ,UAAW,AACX,mBAAoB,AACpB,uBAAwB,AACxB,uBAAyB,AACzB,oBAAsB,AACtB,4BAA8B,CACnC,AACD,sDACM,cAAe,AACf,WAAY,AACZ,YAAa,AACb,YAAa,AACb,mBAAoB,AACpB,oBAAqB,AACrB,kBAAmB,AACnB,WAAe,AACf,UAAW,AACX,eAAgB,AAChB,iBAAkB,AAClB,eAAgB,AAChB,uBAAwB,AACxB,uBAAyB,AACzB,oBAAsB,AACtB,4BAA8B,CACnC,AACD,mBACA,GACI,2BAA4B,AAC5B,SAAW,CACd,AACD,GACI,wBAAyB,AACzB,SAAW,CACd,CACA","file":"404.vue","sourcesContent":["\n.wscn-http404-container[data-v-467f3bfc] {\n  transform: translate(-50%, -50%);\n  position: absolute;\n  top: 40%;\n  left: 50%;\n}\n.wscn-http404[data-v-467f3bfc] {\n  position: relative;\n  width: 1200px;\n  padding: 0 50px;\n  overflow: hidden;\n}\n.wscn-http404 .pic-404[data-v-467f3bfc] {\n    position: relative;\n    float: left;\n    width: 600px;\n    overflow: hidden;\n}\n.wscn-http404 .pic-404__parent[data-v-467f3bfc] {\n      width: 100%;\n}\n.wscn-http404 .pic-404__child[data-v-467f3bfc] {\n      position: absolute;\n}\n.wscn-http404 .pic-404__child.left[data-v-467f3bfc] {\n        width: 80px;\n        top: 17px;\n        left: 220px;\n        opacity: 0;\n        animation-name: cloudLeft;\n        animation-duration: 2s;\n        animation-timing-function: linear;\n        animation-fill-mode: forwards;\n        animation-delay: 1s;\n}\n.wscn-http404 .pic-404__child.mid[data-v-467f3bfc] {\n        width: 46px;\n        top: 10px;\n        left: 420px;\n        opacity: 0;\n        animation-name: cloudMid;\n        animation-duration: 2s;\n        animation-timing-function: linear;\n        animation-fill-mode: forwards;\n        animation-delay: 1.2s;\n}\n.wscn-http404 .pic-404__child.right[data-v-467f3bfc] {\n        width: 62px;\n        top: 100px;\n        left: 500px;\n        opacity: 0;\n        animation-name: cloudRight;\n        animation-duration: 2s;\n        animation-timing-function: linear;\n        animation-fill-mode: forwards;\n        animation-delay: 1s;\n}\n@keyframes cloudLeft {\n0% {\n    top: 17px;\n    left: 220px;\n    opacity: 0;\n}\n20% {\n    top: 33px;\n    left: 188px;\n    opacity: 1;\n}\n80% {\n    top: 81px;\n    left: 92px;\n    opacity: 1;\n}\n100% {\n    top: 97px;\n    left: 60px;\n    opacity: 0;\n}\n}\n@keyframes cloudMid {\n0% {\n    top: 10px;\n    left: 420px;\n    opacity: 0;\n}\n20% {\n    top: 40px;\n    left: 360px;\n    opacity: 1;\n}\n70% {\n    top: 130px;\n    left: 180px;\n    opacity: 1;\n}\n100% {\n    top: 160px;\n    left: 120px;\n    opacity: 0;\n}\n}\n@keyframes cloudRight {\n0% {\n    top: 100px;\n    left: 500px;\n    opacity: 0;\n}\n20% {\n    top: 120px;\n    left: 460px;\n    opacity: 1;\n}\n80% {\n    top: 180px;\n    left: 340px;\n    opacity: 1;\n}\n100% {\n    top: 200px;\n    left: 300px;\n    opacity: 0;\n}\n}\n.wscn-http404 .bullshit[data-v-467f3bfc] {\n    position: relative;\n    float: left;\n    width: 300px;\n    padding: 30px 0;\n    overflow: hidden;\n}\n.wscn-http404 .bullshit__oops[data-v-467f3bfc] {\n      font-size: 32px;\n      font-weight: bold;\n      line-height: 40px;\n      color: #1482f0;\n      opacity: 0;\n      margin-bottom: 20px;\n      animation-name: slideUp;\n      animation-duration: 0.5s;\n      animation-fill-mode: forwards;\n}\n.wscn-http404 .bullshit__headline[data-v-467f3bfc] {\n      font-size: 20px;\n      line-height: 24px;\n      color: #222;\n      font-weight: bold;\n      opacity: 0;\n      margin-bottom: 10px;\n      animation-name: slideUp;\n      animation-duration: 0.5s;\n      animation-delay: 0.1s;\n      animation-fill-mode: forwards;\n}\n.wscn-http404 .bullshit__info[data-v-467f3bfc] {\n      font-size: 13px;\n      line-height: 21px;\n      color: grey;\n      opacity: 0;\n      margin-bottom: 30px;\n      animation-name: slideUp;\n      animation-duration: 0.5s;\n      animation-delay: 0.2s;\n      animation-fill-mode: forwards;\n}\n.wscn-http404 .bullshit__return-home[data-v-467f3bfc] {\n      display: block;\n      float: left;\n      width: 110px;\n      height: 36px;\n      background: #1482f0;\n      border-radius: 100px;\n      text-align: center;\n      color: #ffffff;\n      opacity: 0;\n      font-size: 14px;\n      line-height: 36px;\n      cursor: pointer;\n      animation-name: slideUp;\n      animation-duration: 0.5s;\n      animation-delay: 0.3s;\n      animation-fill-mode: forwards;\n}\n@keyframes slideUp {\n0% {\n    transform: translateY(60px);\n    opacity: 0;\n}\n100% {\n    transform: translateY(0);\n    opacity: 1;\n}\n}\n"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_404_images_404_png__ = __webpack_require__(498);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_404_images_404_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__assets_404_images_404_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_404_images_404_cloud_png__ = __webpack_require__(499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_404_images_404_cloud_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__assets_404_images_404_cloud_png__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      img_404: __WEBPACK_IMPORTED_MODULE_0__assets_404_images_404_png___default.a,
      img_404_cloud: __WEBPACK_IMPORTED_MODULE_1__assets_404_images_404_cloud_png___default.a
    };
  },
...
var update = __webpack_require__(393)("959930bc", content, false);
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept(443, function() {
     var newContent = __webpack_require__(443);
...
module.exports = __webpack_require__.p + "static/img/404.png";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("OOPS!")]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('div', {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(3).rerender("data-v-467f3bfc", module.exports)
  }
}
